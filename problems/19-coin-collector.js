...
const coinCollector = numCoins => {
  //declare an empty collection array
  let collection = [];
  //return a function that takes in a number
  return function(num) {
    //push the input num to collection in backpack
    collection.push(num);
    //if the length after pushing is the numCoins in backpack, return the collection array
