...
const countDownTimer = num => {
  //if the countDown days is greater than zero...
  if (num > 0) {
    //set a days counter equal to the input num
    let days = num;
    //return a function that decrements the days counter
    return function() {
      days--;
      //if the days variable in the backpack is zero, return happy new year
      if (days === 0) {
